...
const menuItems = [
  { path: '/home', label: 'Home', icon: 'M3 12l2-3m0 0l7-4 7 4M5 9v10a1 1 0 001 1h12a1 1 0 001-1V9m-9 11l4-4m0 0l4 4m-4-4v4' },
];
...
const sections = [
  {
    ...
    items: [
      ...
      { path: '/online-game', label: 'Online Game', icon: 'M21 12a9 9 0 01-9 9m9-9a9 9 0 00-9-9m9 9H3m9 9a9 9 0 01-9-9m9 9c1.657 0 3-4.03 3-9s-1.343-9-3-9m0 18c-1.657 0-3-4.03-3-9s1.343-9 3-9m-9-9a9 9 0 019 9' },
    ],
  },
  {
    label: 'Compete',
    items: [
      { path: '/local-tournament', label: 'Local Tournament', icon: 'M12 6V4m0 2a2 2 0 100 4m0-4a2 2 0 110 4m-6 8a2 2 0 100-4m0 4a2 2 0 110-4m0 4v2m0-6V4m6 6v10m6-2a2 2 0 100-4m0 4a2 2 0 110-4m0 4v2m0-6V4' },
      { path: '/online-tournament', label: 'Online Tournament', icon: 'M18.364 5.636l-3.536 3.536m0 5.656l3.536 3.536M9.172 9.172L5.636 5.636m3.536 9.192l-3.536 3.536M21 12a9 9 0 11-18 0 9 9 0 0118 0zm-5 0a4 4 0 11-8 0 4 4 0 018 0z' },
    ],
  },
  {
    label: 'Training',
  ...
  },
  {
    label: 'Analyse',
    items: [
      { path: '/progress', label: 'History', icon: 'M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z' },
      ...
      <Sidebar collapsible="none">
        ...
        <SidebarHeader class="border-b border-slate-800 px-6 py-8">
          <div class="flex items-center gap-3">
            ...
            <h1 class="text-xl font-bold text-white">Darts</h1>
          </div>
        </SidebarHeader>
        ...
        <SidebarContent class="px-2 py-6">
          ...
          <template v-for="section in sections" :key="section.label">
            <SidebarGroup>
              <SidebarGroupLabel class="text-xs font-bold uppercase tracking-wider">{{ section.label }}</SidebarGroupLabel>
              <SidebarGroupContent>
                <SidebarMenu>
