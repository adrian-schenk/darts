<template>
  ...
  >
    ...
    <div v-if="props.capabilities?.showStats?.player?.showName ?? false" class="text-4xl text-white font-bold my-4">
      {{ props.player.playerName }}
    </div>
    <div
      v-if="props.capabilities?.showStats?.player?.showSets ?? false"
